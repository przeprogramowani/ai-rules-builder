...
import { getCollectionBySlug } from '../../../../services/prompt-library/promptCollectionService';
...
export const GET: APIRoute = async ({ locals, url }) => {
  ...
  const hasAccess = locals.promptLibrary.organizations.some((org) => org.id === orgId);
  if (!hasAccess) {
