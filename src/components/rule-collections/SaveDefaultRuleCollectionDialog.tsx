...
interface SaveDefaultRuleCollectionDialogProps {
  isOpen: boolean;
  onClose: () => void;
...
export const SaveDefaultRuleCollectionDialog: React.FC<SaveDefaultRuleCollectionDialogProps> = ({
  isOpen,
  onClose,
  onSave,
  initialName = '',
...
export default SaveDefaultRuleCollectionDialog;
